...
boomer_question = Question.create(title: "Good place to buy boomers?", content: "Does anyone know a good source? I'm in the East Bay.")

boomer_question.answers << Answer.create(content: "I dunno man")
boomer_question.answers << Answer.create(content: "Try People's Park")

joe.questions << boomer_question
